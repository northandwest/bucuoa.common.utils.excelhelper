package com.bucuoa.common;

import java.util.ArrayList;

import com.bucuoa.common.excel.PoiExcel2k3Helper;
import com.bucuoa.common.excel.PoiExcel2k7Helper;
import com.bucuoa.common.excel.PoiExcelHelper;

public  class PoiExcelTest {

	public static void main(String[] args){
		// 获取Excel文件的sheet列表
		testGetSheetList("d:/temp/test100.xlsx");
		
		// 获取Excel文件的第1个sheet的内容
		testReadExcel("d:/temp/test100.xlsx", 0);
//		
